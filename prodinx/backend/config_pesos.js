...
function mapNomeGrupoParaPapel(nomeGrupo) {
  if (!nomeGrupo) {
    return null;
  }
...
function resolverPesosNiveis(papel, subpapel) {
...
function resolverPesosDimensoes(papel, subpapel) {
...
function indicadorAplicaAoSubpapel(subpapeisAplicaveis, subpapel) {
