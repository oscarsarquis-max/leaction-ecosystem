...
export function AssessmentLobby({
  ...
  nextTitle = "Continuar para o Planejamento",
  nextDescription = "Você já iniciou a preparação. O próximo passo é organizar o planejamento da avaliação — equipe, escopo e como o trabalho será conduzido.",
  nextActionText = "Ir para o Planejamento",
  blockers = [],
  onContinue,
  onResolveBlocker,
