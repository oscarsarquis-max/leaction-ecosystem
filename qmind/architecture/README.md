...
- **ISO Intelligence V1 — Cockpit:** [`04_Docs/031_ISO_Intelligence_V1_Cockpit.md`](04_Docs/031_ISO_Intelligence_V1_Cockpit.md) — ISOI-010 (**Core-only**; read model organizacional; sem fan-out OI; OI permanece em `34ead2e`).
