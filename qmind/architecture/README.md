...
- **ISO Intelligence V1 — Improvement Case Evolution:** [`04_Docs/026_ISO_Intelligence_V1_Improvement_Case_Evolution.md`](04_Docs/026_ISO_Intelligence_V1_Improvement_Case_Evolution.md) — ISOI-005 (OutcomeObservation + evolução).
- **ISO Intelligence V1 — Improvement Case Loop Baseline:** [`04_Docs/027_ISO_Intelligence_V1_Improvement_Case_Loop_Baseline.md`](04_Docs/027_ISO_Intelligence_V1_Improvement_Case_Loop_Baseline.md) — ISOI-006 (fechamento da baseline; pins Core `f189a11` / OI `2d78eff`).
- **ISO Intelligence V1 — Action Execution Workspace Ágil:** [`04_Docs/028_ISO_Intelligence_V1_Action_Execution_Workspace.md`](04_Docs/028_ISO_Intelligence_V1_Action_Execution_Workspace.md) — ISOI-007 (**Core-only**; prepara Execution Intelligence futura; OI sem mudança funcional).
- **ISO Intelligence V1 — Evidência e Medição do Resultado:** [`04_Docs/029_ISO_Intelligence_V1_Evidence_Measurement.md`](04_Docs/029_ISO_Intelligence_V1_Evidence_Measurement.md) — ISOI-008 (**Core-only**, **implementado/baseline**, pin `2d09b81`).
- **ISO Intelligence V1 — Execution Intelligence:** [`04_Docs/030_ISO_Intelligence_V1_Execution_Intelligence.md`](04_Docs/030_ISO_Intelligence_V1_Execution_Intelligence.md) — ISOI-009 (**implementado/baseline**, Core pin `21df383`, OI pin `34ead2e`; snapshot factual → OI → histórico/UI).
- **ISO Intelligence V1 — Cockpit:** [`04_Docs/031_ISO_Intelligence_V1_Cockpit.md`](04_Docs/031_ISO_Intelligence_V1_Cockpit.md) — ISOI-010 (**implementado/baseline**, Core pin `9d17fee`; read model organizacional; sem fan-out OI; OI permanece em `34ead2e`).
- **ISO Intelligence V1 — Hotpage e Jornada Pública V2:** [`04_Docs/032_ISO_Intelligence_V1_Hotpage_Public_Journey.md`](04_Docs/032_ISO_Intelligence_V1_Hotpage_Public_Journey.md) — ISOI-011 (**em revisão**; hotpage `/` + tour `/guided-tour`; conteúdo estático público; tour GET-only; OI sem alteração).
