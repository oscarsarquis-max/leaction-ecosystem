 ...
 * DismissSuggestionIn
 */
export type DismissSuggestionIn = {
    /**
     * Reason
     */
    reason: string;
 ...
 * EvolutionCategory
 */
export type EvolutionCategory = 'direction_governance' | 'planning_risks' | 'people_resources' | 'operations_customers' | 'measurement_decisions' | 'correction_improvement';
 ...
 * EvolutionEffort
 */
export type EvolutionEffort = 'high' | 'medium' | 'low';

/**
 * EvolutionGenerateIn
 */
export type EvolutionGenerateIn = {
    mode?: EvolutionGenerationMode | null;
};

/**
 * EvolutionGenerationMode
 */
export type EvolutionGenerationMode = 'preliminary' | 'analysis_ready';

/**
 * EvolutionImpact
 */
export type EvolutionImpact = 'high' | 'medium' | 'low';

/**
 * EvolutionPackageOut
 */
export type EvolutionPackageOut = {
    /**
     * Assessment Id
     */
    assessment_id: string;
     ...
     */
    secondary_suggestions?: Array<EvolutionSuggestionOut>;
    /**
     * Source Fingerprint
     */
 ...
 */
export type EvolutionPackageStatus = 'active' | 'superseded';
...
export type SourceReference = {
     ...
     * Kind
     */
    kind: 'question' | 'guided_answer' | 'evidence' | 'finding' | 'maturity_assessment' | 'maturity_score' | 'action_item' | 'wizard_context';
    /**
     * Label
     */
    label?: string | null;
...
export type GetAssessmentEvolutionMapData = {
    body?: never;
    headers?: {
        /**
         * X-Organization-Id
...
export type GetAssessmentEvolutionMapErrors = {
    /**
     * Bad request / domain guard
     */
    400: ErrorBody;
...
export type GetAssessmentEvolutionMapResponses = {
    /**
     * Response Getassessmentevolutionmap
     * Successful Response
     */
    200: EvolutionPackageOut | null;
};

export type GetAssessmentEvolutionMapResponse = GetAssessmentEvolutionMapResponses[keyof GetAssessmentEvolutionMapResponses];

export type GenerateAssessmentEvolutionMapData = {
    /**
     * Payload
     */
    body?: EvolutionGenerateIn | null;
    headers?: {
        /**
         * Idempotency-Key
         * Optional client idempotency key for safely retrying create/command operations (ADR-003). Scope is the organization. Max 128 chars.
...
export type GenerateAssessmentEvolutionMapErrors = {
    /**
     * Bad request / domain guard
     */
    400: ErrorBody;
...
export type GenerateAssessmentEvolutionMapResponses = {
    /**
     * Successful Response
     */
    200: EvolutionPackageOut;
};

export type GenerateAssessmentEvolutionMapResponse = GenerateAssessmentEvolutionMapResponses[keyof GenerateAssessmentEvolutionMapResponses];
...
export type GetEvolutionSuggestionData = {
    body?: never;
    headers?: {
        /**
         * X-Organization-Id
...
export type GetEvolutionSuggestionErrors = {
    /**
     * Bad request / domain guard
     */
    400: ErrorBody;
...
export type GetEvolutionSuggestionResponses = {
    /**
     * Successful Response
     */
    200: EvolutionSuggestionOut;
};

export type GetEvolutionSuggestionResponse = GetEvolutionSuggestionResponses[keyof GetEvolutionSuggestionResponses];

export type AcceptEvolutionSuggestionData = {
    body?: never;
    headers?: {
        /**
         * Idempotency-Key
...
export type AcceptEvolutionSuggestionErrors = {
    /**
     * Bad request / domain guard
     */
    400: ErrorBody;
...
export type AcceptEvolutionSuggestionResponses = {
    /**
     * Successful Response
     */
    200: EvolutionSuggestionOut;
...
export type DismissEvolutionSuggestionErrors = {
    /**
     * Bad request / domain guard
     */
    400: ErrorBody;
...
export type DismissEvolutionSuggestionResponses = {
    /**
     * Successful Response
     */
    200: EvolutionSuggestionOut;
...
export type DismissEvolutionSuggestionResponse = DismissEvolutionSuggestionResponses[keyof DismissEvolutionSuggestionResponses];

export type InvestigateEvolutionSuggestionData = {
    /**
     * Payload
     */
    body?: InvestigateSuggestionIn | null;
    headers?: {
        /**
         * Idempotency-Key
         * Optional client idempotency key for safely retrying create/command operations (ADR-003). Scope is the organization. Max 128 chars.
...
export type InvestigateEvolutionSuggestionErrors = {
    /**
     * Bad request / domain guard
     */
    400: ErrorBody;
...
export type InvestigateEvolutionSuggestionResponses = {
    /**
     * Successful Response
     */
    200: EvolutionSuggestionOut;
...
export type InvestigateEvolutionSuggestionResponse = InvestigateEvolutionSuggestionResponses[keyof InvestigateEvolutionSuggestionResponses];
...
export type GetReportPdfBytesLocalData = {
    body?: never;
    headers?: {
        /**
         * X-Organization-Id
...
export type GetReportPdfBytesLocalErrors = {
    /**
     * Bad request / domain guard
     */
    400: ErrorBody;
...
export type GetReportPdfBytesLocalResponses = {
    /**
     * Successful Response
     */
    200: unknown;
