...
-- Crystal Ball â€” tabelas isoladas (nunca escreve em pipeline_runs / phase_executions)
...
COMMENT ON TABLE crystal_shadow_runs IS
    'Crystal Ball â€” shadow runs de what-if; isolados dos runs oficiais.';
COMMENT ON TABLE crystal_shadow_phases IS
    'Artefatos copiados ou recalculados em modo simulaÃ§Ã£o.';
COMMENT ON TABLE crystal_predictions IS
    'CalibraÃ§Ã£o previsÃ£o vs quality_score real (sÃ³ relatÃ³rio Crystal Ball).';
