(function () {
    ...
    function abrirModal(modoEdicao) {
        ...
        if (window.PanelDXPasswordToggle) {
            if (codigoInput) window.PanelDXPasswordToggle.clearMasked(codigoInput);
            if (senhaAtualInput) window.PanelDXPasswordToggle.clearMasked(senhaAtualInput);
        }
        ...
        if (window.PanelDXPasswordToggle) {
            window.PanelDXPasswordToggle.init(modal);
        }
    }
    ...
    async function carregarCredenciaisAcesso(idUsuario) {
        ...
        try {
            ...
            if (info.tipo_credencial === 'codigo_lead' && info.credencial_visivel && codigoInput) {
                ...
                if (window.PanelDXPasswordToggle) {
                    window.PanelDXPasswordToggle.setMaskedValue(codigoInput, info.credencial_visivel);
                } else {
                ...
                if (window.PanelDXPasswordToggle) {
                    window.PanelDXPasswordToggle.setMaskedValue(senhaAtualInput, info.credencial_visivel);
                } else {
