/**
 * Radar Chart.js — exclusivo do relatório preliminar (/diagnostico-inicial).
 * Cópia isolada: não altera chart-radar-command-center.js (outras telas).
 */
(function (global) {
    'use strict';
        ...
        return {
            ...
            scales: {
                r: {
                    ...
                    max: max,
                    beginAtZero: true,
                    grid: { circular: true, color: overrides.gridColor || GRID_SILVER, lineWidth: 1 },
                    angleLines: { color: overrides.angleColor || GRID_SILVER, lineWidth: 1 },
                    ticks: {
    ...
    global.PresurveyRadarChart = { create: create };
