...
(function () {
    ...
    var SCRIPTS = {
        ...
        estrategia: [
            ...
            'Os 5 pilares PanelDX já estão prontos — vincule objetivos de TD e KRs para alimentar o Panorama Executivo.',
    ...
    function init() {
        ...
        function updateBubble() {
            ...
            var msg = pickMessage(pool, msgIndex)
                ...
                || 'Siga o fluxo PanelDX: diagnosticar, planejar e executar.';
