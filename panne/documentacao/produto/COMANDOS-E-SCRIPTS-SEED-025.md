...
`start-demo.ps1` (CURSOR-026) sobe API `:5080` e Vite `:5180` só contra `panne_demo`, com autenticador falso e `VITE_DEMO_MODE=1`. Não lê `.env`. Encerrar com `stop-demo.ps1`.
