...
_MESSAGES = {
    ...
    "sale_basis_obrigatoria": "Informe a base comercial do preço (quantidade e unidade) antes de publicar.",
    "politica_vigencia_conflito": "Já existe política ativa com vigência sobreposta para o mesmo escopo.",
    "escopo_canal_nao_suportado": "Escopo canal/estabelecimento ainda não é suportado neste ciclo.",
