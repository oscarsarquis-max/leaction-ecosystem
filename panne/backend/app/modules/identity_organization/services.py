...
def ensure_productive_onboarding(
    ...
    *,
    ...
    """Cria ou reconhece o primeiro cliente numa transação atômica.

    Exige autorização individual emitida pela Panne. A repetição dos mesmos
    dados confirmados devolve os registros existentes.
    """
    from app.modules.identity_organization.onboarding import confirm_client_onboarding

    return confirm_client_onboarding(
        session,
        issuer=issuer,
        subject=subject,
        email=email,
        ...
        establishment_display_name=establishment_display_name,
        holder_kind=holder_kind,
        holder_name=holder_name,
        holder_fiscal_id=holder_fiscal_id,
        formalization_state=formalization_state,
        establishment_nature=establishment_nature,
