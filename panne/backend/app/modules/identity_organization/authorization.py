...
ROLE_PERMISSIONS: dict[str, tuple[str, ...]] = {
    "owner": _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN,
    "organization_owner": (
        _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN
    ),
    "administrator": (
        _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN
    ),
    ...
    "regulatory_reviewer": _REVIEW + _INGREDIENT_READ + _RECIPE_REVIEW + _LABELING_REVIEW,
    "technical_responsible": (
        _READ_ME + _PRODUCTION_TECHNICAL + _INGREDIENT_TECHNICAL + _RECIPE_TECHNICAL + _LABELING_ADMIN
    ),
    "production": _READ_ME + _PRODUCTION_ADMIN + _INGREDIENT_READ + _RECIPE_READ + _LABELING_READ,
    "production_manager": _READ_ME + _PRODUCTION_ADMIN + _INGREDIENT_READ + _RECIPE_READ + _LABELING_READ,
    "commercial": _READ_ME + _INGREDIENT_COMMERCIAL + _RECIPE_READ + _LABELING_READ,
    "baker_operator": _READ_ME + _PRODUCTION_BAKER + (PERMISSION_INGREDIENT_READ,) + _RECIPE_READ + _LABELING_READ,
    "viewer": _READ_ME + _PRODUCTION_READ + _INGREDIENT_READ + _RECIPE_READ + _LABELING_READ,
    "restricted": (),
}
