...
COSTING_PERMISSION_DEFINITIONS = (
    ...
    (PERMISSION_PRICING_SIMULATION_MANAGE, "Simular markup e margens"),
    (PERMISSION_PRICING_REVIEW, "Revisar preço praticado"),
    (PERMISSION_PRICING_PUBLISH, "Publicar preço praticado"),
)
...
ROLE_PERMISSIONS: dict[str, tuple[str, ...]] = {
    ...
    "viewer": _READ_ME + _PRODUCTION_READ + _INGREDIENT_READ + _RECIPE_READ + _PRODUCT_READ + _LABELING_READ + _REPORTING_VIEWER + (PERMISSION_INVENTORY_READ,) + _PROCUREMENT_READ + _FISCAL_READ,
    "restricted": (),
}
