...
ROLE_PERMISSIONS: dict[str, tuple[str, ...]] = {
    "owner": _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN,
    "organization_owner": _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN,
    "administrator": _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN,
    "organization_admin": _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN,
    "regulatory_reviewer": _REVIEW + _INGREDIENT_READ,
    "technical_responsible": _READ_ME + _PRODUCTION_TECHNICAL + _INGREDIENT_TECHNICAL,
    "production": _READ_ME + _PRODUCTION_ADMIN + _INGREDIENT_READ,
    "production_manager": _READ_ME + _PRODUCTION_ADMIN + _INGREDIENT_READ,
    "commercial": _READ_ME + _INGREDIENT_COMMERCIAL,
    "baker_operator": _READ_ME + _PRODUCTION_BAKER + (PERMISSION_INGREDIENT_READ,),
    "viewer": _READ_ME + _PRODUCTION_READ + _INGREDIENT_READ,
    "restricted": (),
}
