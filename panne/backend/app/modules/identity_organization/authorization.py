...
ROLE_PERMISSIONS: dict[str, tuple[str, ...]] = {
    "owner": _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN + _COSTING_ADMIN + _REPORTING_ALL + _INVENTORY_ALL + _PROCUREMENT_ALL,
    "organization_owner": (
        _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN + _COSTING_ADMIN + _REPORTING_ALL + _INVENTORY_ALL + _PROCUREMENT_ALL
    ),
    "administrator": (
        _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN + _COSTING_ADMIN + _REPORTING_ALL + _INVENTORY_ALL + _PROCUREMENT_ALL
    ),
    ...
    "regulatory_reviewer": _REVIEW + _INGREDIENT_READ + _RECIPE_REVIEW + _LABELING_REVIEW + (PERMISSION_COSTING_READ,) + _REPORTING_REVIEW,
    "technical_responsible": (
        _READ_ME + _PRODUCTION_TECHNICAL + _INGREDIENT_TECHNICAL + _RECIPE_TECHNICAL + _LABELING_ADMIN + _COSTING_TECHNICAL + _REPORTING_ALL + _INVENTORY_ALL + _PROCUREMENT_ALL
    ),
    "production": _READ_ME + _PRODUCTION_ADMIN + _INGREDIENT_READ + _RECIPE_READ + _LABELING_READ + _REPORTING_OPERATIONS + _INVENTORY_OPS,
    "production_manager": _READ_ME + _PRODUCTION_ADMIN + _INGREDIENT_READ + _RECIPE_READ + _LABELING_READ + _REPORTING_OPERATIONS + _INVENTORY_OPS,
    "commercial": _READ_ME + _INGREDIENT_COMMERCIAL + _RECIPE_READ + _LABELING_READ + _COSTING_COMMERCIAL + _REPORTING_COMMERCIAL + (PERMISSION_INVENTORY_READ,) + _PROCUREMENT_COMMERCIAL,
    "baker_operator": _READ_ME + _PRODUCTION_BAKER + (PERMISSION_INGREDIENT_READ,) + _RECIPE_READ + _LABELING_READ + _REPORTING_BAKER + _INVENTORY_BAKER,
    "viewer": _READ_ME + _PRODUCTION_READ + _INGREDIENT_READ + _RECIPE_READ + _LABELING_READ + _REPORTING_VIEWER + (PERMISSION_INVENTORY_READ,) + _PROCUREMENT_READ,
    "restricted": (),
}
