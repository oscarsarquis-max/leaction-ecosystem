...
ROLE_PERMISSIONS: dict[str, tuple[str, ...]] = {
    "owner": _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN + _COSTING_ADMIN,
    "organization_owner": (
        _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN + _COSTING_ADMIN
    ),
    "administrator": (
        _REVIEW + _PRODUCTION_ADMIN + _ROLE_MANAGE + _INGREDIENT_ADMIN + _RECIPE_ADMIN + _LABELING_ADMIN + _COSTING_ADMIN
    ),
    ...
    "regulatory_reviewer": _REVIEW + _INGREDIENT_READ + _RECIPE_REVIEW + _LABELING_REVIEW + (PERMISSION_COSTING_READ,),
    "technical_responsible": (
        _READ_ME + _PRODUCTION_TECHNICAL + _INGREDIENT_TECHNICAL + _RECIPE_TECHNICAL + _LABELING_ADMIN + _COSTING_TECHNICAL
    ),
    ...
    "commercial": _READ_ME + _INGREDIENT_COMMERCIAL + _RECIPE_READ + _LABELING_READ + _COSTING_COMMERCIAL,
