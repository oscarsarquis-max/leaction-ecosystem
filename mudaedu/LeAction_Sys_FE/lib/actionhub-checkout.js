...
const CHECKOUT_HANDOFF_SECRET =
    ...
    'MudaEdu-dev-checkout-handoff';

/**
 * Token opcional de handoff MudaEdu → ActionHub (HMAC, válido por 1h).
 */
...
/**
 * URL white-label do ActionHub para contratação/upgrade de plano MudaEdu.
 */
function buildActionHubCheckoutUrl(req, idClie, options = {}) {
    ...
    return `${hubBase}/checkout/MudaEdu?${params.toString()}`;
}
