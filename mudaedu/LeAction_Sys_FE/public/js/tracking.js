/**
 * MudaEdu PLG Tracking — sensor anônimo → POST /api/tracking/enviar (proxy Hub).
 *
 * Equivalente ao hook React `useTracking` (FE do MudaEdu é EJS/vanilla).
 * session_id UUID em localStorage com expiração de 30 dias.
 */
(function (global) {
  'use strict';

  var STORAGE_KEY = 'MudaEdu_crm_session';
