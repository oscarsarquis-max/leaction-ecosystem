# Configuração compartilhada — deploy mudaedu (AWS ECS / ECR na infra PanelDX)
...
$script:DeployHubIntegration = @{
    frontend = @{
        BACKEND_URL                = 'https://mudaedu.com.br'
        HUB_GATEWAY_INTERNAL_URL   = 'https://api.actionhub.com.br'
        HUB_PUBLIC_URL             = 'https://actionhub.com.br'
        HUB_WEBHOOK_URL            = 'https://mudaedu.com.br/api/hub/payment-webhook'
...
# PRODUCTION_MASTER_KEY copiada da task ECS paneldx-frontend (produção PanelDX).
$script:DeployGatekeeperFrontend = @{
    ...
    DB_SSLMODE            = 'require'
    PRODUCTION_MASTER_KEY = 'Cmgv6190!@#'
}
