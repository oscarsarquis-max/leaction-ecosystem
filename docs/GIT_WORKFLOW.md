...
Este documento define como sincronizar o código entre **dois computadores** via GitHub (`oscarsarquis-max`) e como manter um **log de auditoria** adequado ao Go-Live.
...
**Remoto sugerido:** `https://github.com/oscarsarquis-max/leaction-ecosystem.git`
...
2. Conta GitHub `oscarsarquis-max` com repositório vazio criado (sem README, se for o primeiro push).
