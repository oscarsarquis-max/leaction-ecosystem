...
`currentGroup` após 015: **`GROUP_A_VISIBILITY_OBSERVABILITY`**.
...
| 016 | A | Telemetria Canônica e Operational Events | Logs, métricas, traces e eventos correlacionados | PLANNED | NOT_IMPLEMENTED | MOCK_ONLY |
...
- Grupo A: **1/4 VERIFIED**, **3/4 PLANNED**
...
1. Antes de iniciar 016: emitir prompt formalmente (016 permanece PLANNED até lá).
