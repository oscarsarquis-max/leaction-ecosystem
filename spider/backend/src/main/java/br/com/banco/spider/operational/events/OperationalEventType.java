...
public enum OperationalEventType {
  ...
  SATELLITE_REQUEST_RECEIVED(OperationalEventCategory.INTERACTION),
  SATELLITE_AUTHENTICATED(OperationalEventCategory.SECURITY),
  SATELLITE_CONTRACT_VALIDATED(OperationalEventCategory.INTERACTION),
  SATELLITE_OBJECTIVE_ACCEPTED(OperationalEventCategory.CONTEXT),
  SATELLITE_CONTEXT_ACCEPTED(OperationalEventCategory.CONTEXT),
  SATELLITE_DECISION_CREATED(OperationalEventCategory.INTERACTION),
  CAPABILITY_DISPATCHED(OperationalEventCategory.CONTEXT),
  PROVIDER_RESULT_RECEIVED(OperationalEventCategory.TRANSPORT),
  SATELLITE_RESPONSE_RETURNED(OperationalEventCategory.INTERACTION),
