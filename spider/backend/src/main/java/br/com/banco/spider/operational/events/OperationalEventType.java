...
public enum OperationalEventType {
  ...
  INTENT_CREATED(OperationalEventCategory.CONTEXT),
  INTENT_VALIDATED(OperationalEventCategory.CONTEXT),
  EXECUTION_PLAN_RESOLVED(OperationalEventCategory.CONTEXT),
  EXECUTION_PLAN_REJECTED(OperationalEventCategory.CONTEXT),
  CAPABILITY_RESOLVED(OperationalEventCategory.CONTEXT),
  CAPABILITY_UNAVAILABLE(OperationalEventCategory.CONTEXT),
  ROUTE_RESOLVED(OperationalEventCategory.CONTEXT),
  AI_INTERPRETATION_REQUESTED(OperationalEventCategory.CONTEXT),
  AI_INTERPRETATION_SUCCEEDED(OperationalEventCategory.CONTEXT),
  AI_INTERPRETATION_REJECTED(OperationalEventCategory.CONTEXT),
  AI_INTERPRETATION_FAILED(OperationalEventCategory.CONTEXT),
  CONTEXTUAL_LINK_CLICKED(OperationalEventCategory.CONTEXT),
  CLICK_CONTEXT_CREATED(OperationalEventCategory.CONTEXT),
  PAGE_CONTEXT_ACQUISITION_STARTED(OperationalEventCategory.CONTEXT),
  PAGE_CONTEXT_ACQUIRED(OperationalEventCategory.CONTEXT),
  PAGE_CONTEXT_ACQUISITION_FAILED(OperationalEventCategory.CONTEXT),
  SPIDERBANK_REDIRECT_CREATED(OperationalEventCategory.CONTEXT),
  OBJECTIVE_DECLARED(OperationalEventCategory.CONTEXT),
  CONTEXT_ENRICHMENT_APPLIED(OperationalEventCategory.CONTEXT),
