"""Retrieval S2S do card AEE modificado (prompt 86). Zero IA."""
...
def card_modificado():
    """Card já gerado em lote (79/81), só se a turma tiver AEE ativo."""
    ...
    return jsonify(
        {
            ...
            "item": {
                ...
                "passos_adaptados": row.get("passos_adaptados"),
