...
const TREINO_ESCOLA: BlocoTreino[] = [
  {
    ...
    cor: '#1f6f4a',
    intro:
      'Papel da coordenação: organizar a estrutura acadêmica (curso → turma e disciplina) e o método antes da aula existir.',
    passos: [
      {
        titulo: 'Entrar',
        icon: LogIn,
      ...
      },
      {
        ...
        icon: Building2,
        itens: [
          'Confira a unidade e o período letivo em andamento.',
          'Clique em um curso: turmas e disciplinas aparecem dentro dele. Toda turma pertence a um curso — não existe turma “sem curso”.',
...
const TREINO_PROFESSOR: BlocoTreino[] = [
  {
    ...
    /** No roteiro autenticado o bloco B usa marrom; em /inove4us alinhamos ao bordo da Posicionamento (Inove4Us). */
    cor: '#7a2331',
    intro:
...
export default function Inove4usPage() {
