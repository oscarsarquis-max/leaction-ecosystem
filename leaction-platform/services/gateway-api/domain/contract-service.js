  ...
  async function activateFromOrder(orderId) {
    ...
    try {
      ...
      const outboxPayload = {
        ...
        payer_email: hubPayload?.payer_email || null,
        razao_social: hubPayload?.razao_social || null,
        payer_document: hubPayload?.payer_document || null,
        payer_document_type: hubPayload?.payer_document_type || null,
        direitos,
